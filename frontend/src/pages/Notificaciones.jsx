...
import { Bell, Check, Trash2, ExternalLink, AlertTriangle, Package, Wrench, CheckCircle2, MessageSquare, Unlock, Square, CheckSquare, XSquare } from 'lucide-react';
...
const notificationIcons = {
  ...
  presupuesto_rechazado: AlertTriangle,
};
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <p className={`text-sm ${!notificacion.leida ? 'font-semibold' : ''}`}>
                          ...
                          <div className="flex items-center gap-2 mt-1 flex-wrap">
                            ...
                            <Badge variant="outline" className="text-[9px] h-4">{notificacion.tipo?.replace(/_/g, ' ')}</Badge>
                          </div>
                        </div>
