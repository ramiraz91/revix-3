...
export default function GLSEnvioPanel({ orden, onUpdate }) {
  ...
  // Filtrar envíos mock_preview — solo mostramos envíos REALES de producción.
  // Los mocks de preview se ignoran completamente para no confundir al admin/cliente.
  const envios = (detail?.envios || []).filter((e) => !e.mock_preview);
  const envioActual =
